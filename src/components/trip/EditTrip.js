...
function EditTrip(props) {
  ...
  useEffect(()=>{
    ...
    .then(res=>{
      ...
      setServicesProvided(res.data.service_provided)
      setExcludes(res.data.excludes)
        ...
        <div className="col-md-7">
          <form className="container mt-2 pt-2 pb-4">
            <div className="form-group">
              <label>Title</label>
              <input value={title} onChange={e=> setTitle(e.target.value)} type="text" className="form-control" placeholder='Trip Title' />
            </div>
            <div className="form-group">
              <label>Price</label>
              <input value={price} onChange={e=> setPrice(e.target.value)} type="number" className="form-control" min='0' placeholder='Trip Price e.g 15000' />
            </div>
            <div className="form-group">
              <label>Description</label>
              <textarea rows="4" value={description} onChange={e=> setDescription(e.target.value)} type="text" className="form-control" placeholder='Description (max 120 words)' />
            </div>
            <div className="form-group">
              <label>Attractions</label>
              <textarea rows="4" value={attractions} onChange={e=> setAttractions(e.target.value)} type="text" className="form-control" placeholder='Describe trip atrractions' />
            </div>
            <div className="form-group">
              <label>Excludes</label>
              <textarea rows="4" value={excludes} onChange={e=> setExcludes(e.target.value)} type="text" className="form-control" placeholder='Trip exludes' />
            </div>
            <div className="form-group">
              <label>Services Provided</label>
              <textarea rows="4" value={service_provided} onChange={e=> setServicesProvided(e.target.value)} type="text" className="form-control" placeholder='Describe services to be provided' />
            </div>
            <div className="form-group">
              <label>Company</label>
              <input value={company} onChange={e=> setCompany(e.target.value)} type="text" className="form-control" placeholder='Company Name' />
            </div>
            <div className="form-group">
              <label>Start Date</label>
              <input value={start_date} onChange={e=>{setStartDate(e.target.value)}} type="date" className="form-control" />
            </div>
            <div className="form-group">
              <label>End Date</label>
              <input value={end_date} onChange={e=>{setEndDate(e.target.value)}} type="date" className="form-control" />
            </div>
            <div className="form-group">
